...
LDFLAGS ?= '-s -w \
	-X "github.com/ks6088ts-labs/cogsearchctl/internal.Revision=$(GIT_REVISION)" \
	-X "github.com/ks6088ts-labs/cogsearchctl/internal.Version=$(GIT_TAG)" \
'
BIN_FILE ?= dist/cogsearchctl
...
build: ## build applications
	$(GOBUILD) -ldflags=$(LDFLAGS) -o $(BIN_FILE) .
